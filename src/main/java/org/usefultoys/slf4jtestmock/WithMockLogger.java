...
public @interface WithMockLogger {
    /**
     * List of logger names to be reset (cleared) before and after each test.
     * <p>
     * This is useful for resetting loggers that are used internally by the code under test
     * but are not injected into the test class.
     * </p>
